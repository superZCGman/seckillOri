...
function SmoothlyMenu() {
    if (!$('body').hasClass('mini-navbar')) {
        $('#side-menu').hide();
        $('.navbar-minimalize i').removeClass("fa fa-angle-double-right");
        $('.navbar-minimalize i').addClass("fa fa-angle-double-left");
        setTimeout(
            function () {
        ...
        $('#side-menu').hide();
        $('.navbar-minimalize i').removeClass("fa fa-angle-double-left");
        $('.navbar-minimalize i').addClass("fa fa-angle-double-right");
        setTimeout(
            function () {
                $('#side-menu').fadeIn(500);
            }, 300);
